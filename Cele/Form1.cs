...
namespace Cele
{
    public partial class Form1 : Form
    {
        ...
        private void BuildUI()
        {
            ...
            Label aboutText = new Label
            {
                ...
                Text = "Project Cele (working title)\nMarch Patch 2.0\n\n" +
                       ...
                       "Patch 2.0 \"March\" Notes:\n" +
                       "- Added \"Smol Cele\" mini player (click album art while playing)\n" +
                       "- Added keyboard shortcuts (Space = Play/Pause, < = Prev, > = Next)\n" +
                       "- Added search in All Tracks tab\n" +
                       "- Added volume mixer in playback bar\n" +
                       "- Fixed album tracklist not clearing when switching tabs\n" +
                       "- Fixed info panels covering track lists\n" +
                       "- Replaced emoji symbols with proper Unicode text\n\n" +
                       "Patch 1.5.1 Notes:\n" +
            ...
            int btnY = 15;
            int btnX = 10;
            Button btnHardReset = new Button { Text = "Hard Reset", Location = new Point(btnX, btnY), Width = 100, Height = 30 };
            btnHardReset.Click += BtnHardReset_Click;
            btnPanel.Controls.Add(btnHardReset);
            btnX += 110;
            Button btnHiddenArtists = new Button { Text = "Hidden Artists", Location = new Point(btnX, btnY), Width = 110, Height = 30 };
            btnHiddenArtists.Click += BtnHiddenArtists_Click;
            btnPanel.Controls.Add(btnHiddenArtists);
            btnX += 120;
            Button btnToggleJson = new Button { Text = useJsonFormat ? "Use .dat" : "Use .json", Location = new Point(btnX, btnY), Width = 90, Height = 30 };
            ...
            btnX += 100;
            Button btnMigrate = new Button { Text = "Migrate to .json", Location = new Point(btnX, btnY), Width = 120, Height = 30 };
            btnMigrate.Click += BtnMigrate_Click;
            btnPanel.Controls.Add(btnMigrate);
            btnX += 130;
            Button btnToggleTheme = new Button { Text = useXpStyle ? "Aero Theme" : "XP Theme", Location = new Point(btnX, btnY), Width = 100, Height = 30, BackColor = useXpStyle ? Color.LightBlue : SystemColors.Control };
            btnToggleTheme.Click += (s, ev) => { useXpStyle = !useXpStyle; SaveSettings(); MessageBox.Show("Theme will change on next restart!", "Theme Toggle", MessageBoxButtons.OK, MessageBoxIcon.Information); };
            btnPanel.Controls.Add(btnToggleTheme);
            btnX += 110;
            Button btnTogglePreferism = new Button { Text = preferismEnabled ? "Disable Preferism" : "Enable Preferism", Location = new Point(btnX, btnY), Width = 140, Height = 30, BackColor = preferismEnabled ? Color.LightGreen : Color.LightCoral };
            ...
            listView = new ListView { Dock = DockStyle.Fill, View = View.Details, FullRowSelect = true, HideSelection = false };
            ...
            Panel searchPanel = new Panel { Height = 40, Dock = DockStyle.Top, BackColor = Color.FromArgb(245, 248, 252) };
            Label lblSearch = new Label { Text = "Search:", Location = new Point(10, 12), AutoSize = true };
            searchPanel.Controls.Add(lblSearch);
            txtSearch = new System.Windows.Forms.TextBox { Location = new Point(65, 9), Width = 300 };
            txtSearch.TextChanged += TxtSearch_TextChanged;
            searchPanel.Controls.Add(txtSearch);
            btnClearSearch = new Button { Text = "Clear", Location = new Point(370, 8), Width = 60, Height = 23 };
            btnClearSearch.Click += (s, ev) => { txtSearch.Text = ""; };
            searchPanel.Controls.Add(btnClearSearch);
            tabTracks.Controls.Add(searchPanel);
            searchPanel.BringToFront();
            trackInfoPanel = new Panel { Height = 105, Dock = DockStyle.Top, BackColor = Color.FromArgb(240, 245, 250), Visible = false };
            tabTracks.Controls.Add(trackInfoPanel);
            trackInfoPanel.BringToFront();
            trackCoverPic = new PictureBox { Size = new Size(80, 80), Location = new Point(10, 10), SizeMode = PictureBoxSizeMode.Zoom, BorderStyle = BorderStyle.FixedSingle };
            ...
            listViewArtists = new ListView { Dock = DockStyle.Fill, View = View.LargeIcon, FullRowSelect = true };
            ...
            artistInfoPanel = new Panel { Height = 105, Dock = DockStyle.Top, BackColor = Color.FromArgb(240, 245, 250), Visible = false };
            tabArtists.Controls.Add(artistInfoPanel);
            artistInfoPanel.BringToFront();
            artistCoverPic = new PictureBox { Size = new Size(80, 80), Location = new Point(10, 10), SizeMode = PictureBoxSizeMode.Zoom, BorderStyle = BorderStyle.FixedSingle };
            ...
            listViewAlbums = new ListView { Dock = DockStyle.Fill, View = View.LargeIcon, FullRowSelect = true };
            ...
            albumInfoPanel = new Panel { Height = 105, Dock = DockStyle.Top, BackColor = Color.FromArgb(240, 245, 250), Visible = false };
            tabAlbums.Controls.Add(albumInfoPanel);
            albumInfoPanel.BringToFront();
            albumCoverPic = new PictureBox { Size = new Size(80, 80), Location = new Point(10, 10), SizeMode = PictureBoxSizeMode.Zoom, BorderStyle = BorderStyle.FixedSingle, Cursor = Cursors.Hand };
            ...
            picCover = new PictureBox { Location = new Point(10, 420), Size = new Size(120, 120), SizeMode = PictureBoxSizeMode.Zoom, BorderStyle = BorderStyle.FixedSingle, Cursor = Cursors.Hand };
            picCover.Click += (s, e) => { if (currentIndex >= 0) ShowMiniPlayer(); };
            if (!useXpStyle) picCover.Paint += PicCover_Paint;
            ...
            if (!useXpStyle) bottomPanel.Paint += BottomPanel_Paint;
            else bottomPanel.BackColor = SystemColors.Control;
            ...
            Label lblVolume = new Label { Text = "Volume:", Location = new Point(850, 33), AutoSize = true, Font = new Font("Segoe UI", 9f), BackColor = Color.Transparent };
            bottomPanel.Controls.Add(lblVolume);
            volumeSlider = new TrackBar { Location = new Point(905, 25), Width = 80, Height = 45, Minimum = 0, Maximum = 100, Value = 50, TickStyle = TickStyle.None };
            volumeSlider.ValueChanged += VolumeSlider_ValueChanged;
            bottomPanel.Controls.Add(volumeSlider);
        ...
        {
            return new Button { Text = text, Font = new Font("Segoe UI", 9f, FontStyle.Bold), Size = new Size(width, 42), Location = new Point(x, 20), FlatStyle = useXpStyle ? FlatStyle.Standard : FlatStyle.System };
        }
        ...
        private void PicCover_Paint(object sender, PaintEventArgs e)
        {
            ...
            Rectangle r = picCover.ClientRectangle;
            r.Inflate(-2, -2);
            using (Pen glow = new Pen(Color.FromArgb(120, 170, 220), 2))
                e.Graphics.DrawRectangle(glow, r);
        }

        private string GetArtistDataPath() { return Path.Combine(Application.StartupPath, useJsonFormat ? "artists.json" : "artists.dat"); }
        private string GetAlbumDataPath() { return Path.Combine(Application.StartupPath, useJsonFormat ? "albums.json" : "albums.dat"); }
            ...
            try
            {
                ...
                else
                {
                    foreach (string line in System.IO.File.ReadAllLines(dataPath))
                    {
                        string[] parts = line.Split('|');
                        if (parts.Length >= 3)
                            artistData[parts[0]] = new ArtistInfo { Name = parts[0], Born = parts[1], CustomImage = parts[2], PreferenceBoost = parts.Length > 3 ? int.Parse(parts[3]) : 0, MergedWith = parts.Length > 4 ? parts[4] : "" };
                    }
                }
            }
            catch { }
            ...
            try
            {
                ...
                else
                {
                    foreach (string line in System.IO.File.ReadAllLines(dataPath))
                    {
                        string[] parts = line.Split('|');
                        if (parts.Length >= 5)
                            albumData[parts[0]] = new AlbumInfo { Name = parts[0], CustomCover = parts[1], CustomArtist = parts[2], Type = parts[3], Year = parts[4], PreferenceBoost = parts.Length > 5 ? int.Parse(parts[5]) : 0 };
                    }
                }
            }
            catch { }
        ...
        private void LoadHiddenArtists()
        {
            ...
            if (!System.IO.File.Exists(dataPath)) return;
            try { hiddenArtists = new List<string>(System.IO.File.ReadAllLines(dataPath)); }
            catch { }
        }
        ...
        {
            string dataPath = Path.Combine(Application.StartupPath, "hidden_artists.dat");
            try { System.IO.File.WriteAllLines(dataPath, hiddenArtists.ToArray()); }
            catch { }
        }
        ...
        private Dictionary<string, ArtistInfo> DeserializeArtistData(string json)
        {
            ...
            foreach (string entry in entries)
            {
                ...
                if (parts.Length >= 11)
                {
                    ...
                    result[name] = new ArtistInfo { Name = UnescapeJson(parts[2]), Born = UnescapeJson(parts[4]), CustomImage = UnescapeJson(parts[6]), PreferenceBoost = int.Parse(parts[8]), MergedWith = UnescapeJson(parts[10]) };
                }
            }
            return result;
        }
        ...
        private Dictionary<string, AlbumInfo> DeserializeAlbumData(string json)
        {
            ...
            foreach (string entry in entries)
            {
                ...
                {
                    string name = UnescapeJson(parts[0]);
                    result[name] = new AlbumInfo { Name = UnescapeJson(parts[2]), CustomCover = UnescapeJson(parts[4]), CustomArtist = UnescapeJson(parts[6]), Type = UnescapeJson(parts[8]), Year = UnescapeJson(parts[10]), PreferenceBoost = int.Parse(parts[12]) };
                }
            }
            return result;
        }
        ...
        {
            DialogResult result = MessageBox.Show("WARNING: This will delete ALL app data!\n\n- Artist info\n- Album info\n- Hidden artists\n- Preferences\n\nYour music files will NOT be deleted.\n\nAre you sure?", "Hard Reset", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            if (result == DialogResult.Yes)
            {
                try
                {
                    string[] filesToDelete = { "artists.dat", "artists.json", "albums.dat", "albums.json", "hidden_artists.dat", "settings.dat" };
        ...
        {
            if (hiddenArtists.Count == 0) { MessageBox.Show("No hidden artists.", "Hidden Artists", MessageBoxButtons.OK, MessageBoxIcon.Information); return; }
            Form hiddenForm = new Form { Text = "Hidden Artists", Width = 500, Height = 400, FormBorderStyle = FormBorderStyle.Sizable, StartPosition = FormStartPosition.CenterParent };
            ListView hiddenList = new ListView { Dock = DockStyle.Fill, View = View.Details, FullRowSelect = true };
            ...
            Button btnRevive = new Button { Text = "Revive Selected", Dock = DockStyle.Bottom, Height = 40 };
        ...
        {
            DialogResult result = MessageBox.Show("Migrate .dat files to .json?\n\nThis will convert:\n- artists.dat -> artists.json\n- albums.dat -> albums.json\n\nOld .dat files will be kept as backup.", "Migrate to JSON", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (result == DialogResult.Yes)
            {
                try
                {
                ...
                catch (Exception ex) { MessageBox.Show("Error during migration: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
            }
        }
        ...
        private void ScanMusic(string folder)
        {
            ...
            foreach (string file in Directory.GetFiles(folder, "*.mp3", SearchOption.AllDirectories))
            {
                try
                {
                    ...
                    tracks.Add(new Track { FilePath = file, Title = tagFile.Tag.Title ?? Path.GetFileNameWithoutExtension(file), Artist = tagFile.Tag.FirstPerformer ?? "Unknown Artist", Album = tagFile.Tag.Album ?? "Unknown Album", Genre = tagFile.Tag.FirstGenre ?? "Unknown Genre", Year = (int)tagFile.Tag.Year, TrackNumber = (int)tagFile.Tag.Track, Duration = tagFile.Properties.Duration, Cover = cover });
                }
                catch { }
            }
        }
        ...
        {
            foreach (Image img in artistImageList.Images) { if (img != null) img.Dispose(); }
            listViewArtists.Items.Clear();
            artistImageList.Images.Clear();
            int idx = 0;
            List<string> allHiddenArtists = new List<string>(hiddenArtists);
            foreach (var kvp in artistData) { if (!string.IsNullOrEmpty(kvp.Value.MergedWith)) allHiddenArtists.Add(kvp.Key); }
            foreach (string artist in tracks.Select(t => t.Artist).Distinct().Where(a => !allHiddenArtists.Contains(a)).OrderBy(a => a))
            {
                ...
                if (!string.IsNullOrEmpty(info.CustomImage) && System.IO.File.Exists(info.CustomImage)) { try { artistImage = Image.FromFile(info.CustomImage); } catch { } }
                if (artistImage == null)
                {
                    var artistTracks = tracks.Where(t => t.Artist == artist && t.Cover != null).ToList();
                    if (artistTracks.Any()) { var rnd = new Random(artist.GetHashCode()); artistImage = artistTracks[rnd.Next(artistTracks.Count)].Cover; }
                }
                if (artistImage == null) { Bitmap bmp = new Bitmap(64, 64); using (Graphics g = Graphics.FromImage(bmp)) g.Clear(Color.Gray); artistImage = bmp; }
        ...
        {
            foreach (Image img in albumImageList.Images) { if (img != null) img.Dispose(); }
            ...
            foreach (var album in tracks.Select(t => t.Album).Distinct().OrderBy(a => a))
            {
                ...
                if (!string.IsNullOrEmpty(info.CustomCover) && System.IO.File.Exists(info.CustomCover)) { try { albumCover = Image.FromFile(info.CustomCover); } catch { } }
                if (albumCover == null) albumCover = t.Cover;
                if (albumCover == null) { Bitmap bmp = new Bitmap(64, 64); using (Graphics g = Graphics.FromImage(bmp)) g.Clear(Color.Gray); albumCover = bmp; }
        ...
        private void TabControl_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (tabControl.SelectedTab == tabTracks) { txtSearch.Text = ""; LoadAllTracks(); }
        }

        private void ListView_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listView.SelectedItems.Count == 0) { trackInfoPanel.Visible = false; return; }
        ...
        {
            if (listViewAlbums.SelectedItems.Count == 0) { albumInfoPanel.Visible = false; return; }
            string album = (string)listViewAlbums.SelectedItems[0].Tag;
            AlbumInfo info = GetAlbumInfo(album);
            currentAlbumTracks = tracks.Where(t => t.Album == album).OrderBy(t => t.TrackNumber).ThenBy(t => t.Title).ToList();
            var first = currentAlbumTracks.First();
            if (!string.IsNullOrEmpty(info.CustomCover) && System.IO.File.Exists(info.CustomCover)) { try { albumCoverPic.Image = Image.FromFile(info.CustomCover); } catch { albumCoverPic.Image = first.Cover; } }
            else albumCoverPic.Image = first.Cover;
        ...
        {
            if (listViewArtists.SelectedItems.Count == 0) { artistInfoPanel.Visible = false; return; }
            ...
            if (!string.IsNullOrEmpty(info.MergedWith)) lblArtistMostPlayed.Text += " [Merged with: " + info.MergedWith + "]";
        ...
        private void BtnPrev_Click(object sender, EventArgs e)
        {
            ...
            if (player.Ctlcontrols.currentPosition > PREV_RESTART_THRESHOLD) player.Ctlcontrols.currentPosition = 0;
            else if (currentIndex > 0) PlayTrack(currentIndex - 1);
        }

        private void BtnPlay_Click(object sender, EventArgs e)
        {
            if (player.playState == WMPLib.WMPPlayState.wmppsPlaying) { player.Ctlcontrols.pause(); btnPlay.Text = "►"; isPlaying = false; }
            else { if (currentIndex == -1 && tracks.Count > 0) PlayTrack(0); else player.Ctlcontrols.play(); btnPlay.Text = "⏸"; isPlaying = true; }
        }
        ...
        private void BtnStop_Click(object sender, EventArgs e)
        {
            ...
            var albumTracks = tracks.Where(t => t.Album == album).OrderBy(t => t.TrackNumber).ThenBy(t => t.Title).ToList();
        ...
        {
            if (currentIndex < tracks.Count - 1) PlayTrack(currentIndex + 1);
        }

        private void Player_PlayStateChange(object sender, AxWMPLib._WMPOCXEvents_PlayStateChangeEvent e)
        {
            if (e.newState == (int)WMPLib.WMPPlayState.wmppsStopped && isPlaying) BtnNext_Click(null, null);
            else if (e.newState == (int)WMPLib.WMPPlayState.wmppsPlaying) { btnPlay.Text = "⏸"; isPlaying = true; }
            else if (e.newState == (int)WMPLib.WMPPlayState.wmppsPaused) { btnPlay.Text = "►"; isPlaying = false; }
        }
        ...
        private Track GetWeightedRandomTrack()
        {
            ...
            foreach (Track t in tracks.Where(tr => !hiddenArtists.Contains(tr.Artist)))
            {
                ...
                for (int i = 0; i < weight; i++) weightedTracks.Add(t);
            }
        ...
        private void BtnShuffleAll_Click(object sender, EventArgs e)
        {
            ...
            if (t != null) PlayTrack(tracks.IndexOf(t));
        }
        ...
        private void BtnAlbumEdit_Click(object sender, EventArgs e)
        {
            ...
            string album = (string)listViewAlbums.SelectedItems[0].Tag;
            AlbumInfo info = GetAlbumInfo(album);
            Form editForm = new Form { Text = "Edit " + album, Width = 450, Height = 280, FormBorderStyle = FormBorderStyle.FixedDialog, StartPosition = FormStartPosition.CenterParent, MaximizeBox = false, MinimizeBox = false };
            ...
            btnBrowseCover.Click += (s, ev) => { OpenFileDialog ofd = new OpenFileDialog { Filter = "Image Files|*.jpg;*.jpeg;*.png;*.bmp" }; if (ofd.ShowDialog() == DialogResult.OK) txtCover.Text = ofd.FileName; };
            ...
            ComboBox cmbType = new ComboBox { Location = new Point(120, 98), Width = 285, DropDownStyle = ComboBoxStyle.DropDownList };
            ...
            btnSave.Click += (s, ev) => { info.CustomCover = txtCover.Text; info.CustomArtist = txtArtist.Text; info.Type = cmbType.SelectedItem != null ? cmbType.SelectedItem.ToString() : "Album"; info.Year = txtYear.Text; SaveAlbumData(); LoadAlbums(); editForm.DialogResult = DialogResult.OK; };
            ...
            if (editForm.ShowDialog() == DialogResult.OK) ListViewAlbums_SelectedIndexChanged(null, null);
        }
        ...
        private void BtnAlbumPrefer_Click(object sender, EventArgs e)
        {
            ...
            string album = (string)listViewAlbums.SelectedItems[0].Tag;
            AlbumInfo info = GetAlbumInfo(album);
            if (info.PreferenceBoost > 0) { info.PreferenceBoost = 0; btnAlbumPrefer.BackColor = SystemColors.Control; MessageBox.Show(album + " removed from preferences.", "Preferism", MessageBoxButtons.OK, MessageBoxIcon.Information); }
            else { info.PreferenceBoost = 10; btnAlbumPrefer.BackColor = Color.LightGreen; MessageBox.Show(album + " now has +10% boost in shuffle!\n\nWhen shuffling all tracks, this album's songs are more likely to play.", "Preferism", MessageBoxButtons.OK, MessageBoxIcon.Information); }
            SaveAlbumData();
        }
        ...
        private void BtnArtistEdit_Click(object sender, EventArgs e)
        {
            ...
            string artist = (string)listViewArtists.SelectedItems[0].Tag;
            ArtistInfo info = GetArtistInfo(artist);
            Form editForm = new Form { Text = "Edit " + artist, Width = 450, Height = 260, FormBorderStyle = FormBorderStyle.FixedDialog, StartPosition = FormStartPosition.CenterParent, MaximizeBox = false, MinimizeBox = false };
            ...
            btnBrowse.Click += (s, ev) => { OpenFileDialog ofd = new OpenFileDialog { Filter = "Image Files|*.jpg;*.jpeg;*.png;*.bmp" }; if (ofd.ShowDialog() == DialogResult.OK) txtImage.Text = ofd.FileName; };
            Label lblMerge = new Label { Text = "Merge with:", Location = new Point(20, 100), AutoSize = true };
            ComboBox cmbMerge = new ComboBox { Location = new Point(120, 98), Width = 285, DropDownStyle = ComboBoxStyle.DropDownList };
            cmbMerge.Items.Add("");
            foreach (string a in tracks.Select(t => t.Artist).Distinct().Where(a => a != artist).OrderBy(a => a)) cmbMerge.Items.Add(a);
            ...
            btnSave.Click += (s, ev) => { info.Born = txtBorn.Text; info.CustomImage = txtImage.Text; info.MergedWith = cmbMerge.SelectedItem != null ? cmbMerge.SelectedItem.ToString() : ""; if (!string.IsNullOrEmpty(info.MergedWith)) { ArtistInfo targetInfo = GetArtistInfo(info.MergedWith); info.PreferenceBoost = targetInfo.PreferenceBoost; } SaveArtistData(); LoadArtists(); editForm.DialogResult = DialogResult.OK; };
            btnCancel.Click += (s, ev) => editForm.DialogResult = DialogResult.Cancel;
            ...
            editForm.Controls.Add(btnSave);
            editForm.Controls.Add(btnCancel);
            if (editForm.ShowDialog() == DialogResult.OK) ListViewArtists_SelectedIndexChanged(null, null);
        }
        ...
        private void BtnArtistPrefer_Click(object sender, EventArgs e)
        {
            ...
            string artist = (string)listViewArtists.SelectedItems[0].Tag;
            ArtistInfo info = GetArtistInfo(artist);
            if (info.PreferenceBoost > 0) { info.PreferenceBoost = 0; btnArtistPrefer.BackColor = SystemColors.Control; MessageBox.Show(artist + " removed from preferences.", "Preferism", MessageBoxButtons.OK, MessageBoxIcon.Information); }
            else { info.PreferenceBoost = 10; btnArtistPrefer.BackColor = Color.LightGreen; MessageBox.Show(artist + " now has +10% boost in shuffle!\n\nWhen shuffling all tracks, this artist's songs are more likely to play.", "Preferism", MessageBoxButtons.OK, MessageBoxIcon.Information); }
            SaveArtistData();
        }
        ...
        private void BtnArtistDelete_Click(object sender, EventArgs e)
        {
            if (listViewArtists.SelectedItems.Count == 0) return;
            string artist = (string)listViewArtists.SelectedItems[0].Tag;
            DialogResult result = MessageBox.Show("Hide " + artist + " from your library?\n\nThis won't delete their music files, just hide them from the app.", "Hide Artist", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (result == DialogResult.Yes) { hiddenArtists.Add(artist); SaveHiddenArtists(); LoadAllTracks(); LoadArtists(); artistInfoPanel.Visible = false; MessageBox.Show(artist + " has been hidden.", "Done", MessageBoxButtons.OK, MessageBoxIcon.Information); }
        }
        ...
        private void ProgressTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (duration > 0) { progressBar.Maximum = (int)duration; progressBar.Value = Math.Min((int)position, progressBar.Maximum); lblTime.Text = FormatTime(position) + " / " + FormatTime(duration); }
        }
        ...
        private void TxtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            listView.Items.Clear();
            var filtered = string.IsNullOrEmpty(search) ? tracks.Where(t => !hiddenArtists.Contains(t.Artist)) : tracks.Where(t => !hiddenArtists.Contains(t.Artist) && (t.Title.ToLower().Contains(search) || t.Artist.ToLower().Contains(search) || t.Album.ToLower().Contains(search)));
            foreach (Track t in filtered.OrderBy(t => t.Title))
            {
                ListViewItem item = new ListViewItem(t.Title);
                item.SubItems.Add(t.Artist);
                item.SubItems.Add(t.Album);
        ...
        {
            if (keyData == Keys.Space) { BtnPlay_Click(null, null); return true; }
            if (keyData == Keys.Oemcomma || keyData == (Keys.Shift | Keys.Oemcomma)) { BtnPrev_Click(null, null); return true; }
            if (keyData == Keys.OemPeriod || keyData == (Keys.Shift | Keys.OemPeriod)) { BtnNext_Click(null, null); return true; }
            return base.ProcessCmdKey(ref msg, keyData);
        }

        private void ShowMiniPlayer()
        {
            if (miniPlayer != null && !miniPlayer.IsDisposed) { miniPlayer.BringToFront(); return; }
            miniPlayer = new Form { Text = "Smol Cele", Width = 220, Height = 280, FormBorderStyle = FormBorderStyle.SizableToolWindow, StartPosition = FormStartPosition.Manual, TopMost = true, Location = new Point(Screen.PrimaryScreen.WorkingArea.Right - 230, Screen.PrimaryScreen.WorkingArea.Bottom - 290) };
            PictureBox miniCover = new PictureBox { Size = new Size(180, 180), Location = new Point(10, 10), SizeMode = PictureBoxSizeMode.Zoom, BorderStyle = BorderStyle.FixedSingle, Image = picCover.Image };
            miniPlayer.Controls.Add(miniCover);
            Label miniTitle = new Label { Location = new Point(10, 200), Width = 180, Height = 20, Text = lblTitle.Text, Font = new Font("Segoe UI", 8f, FontStyle.Bold), TextAlign = ContentAlignment.MiddleCenter };
            miniPlayer.Controls.Add(miniTitle);
            Label miniArtist = new Label { Location = new Point(10, 220), Width = 180, Height = 20, Text = lblArtistAlbum.Text, Font = new Font("Segoe UI", 7f), TextAlign = ContentAlignment.MiddleCenter };
            miniPlayer.Controls.Add(miniArtist);
            Timer updateTimer = new Timer { Interval = 500 };
            updateTimer.Tick += (s, ev) => { if (miniPlayer.IsDisposed) { updateTimer.Stop(); return; } miniCover.Image = picCover.Image; miniTitle.Text = lblTitle.Text; miniArtist.Text = lblArtistAlbum.Text; };
            updateTimer.Start();
            miniPlayer.FormClosed += (s, ev) => { updateTimer.Stop(); miniPlayer = null; };
            miniPlayer.Show();
        }
    ...
    public class AeroProgressBar : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (UseXpStyle)
            {
                using (SolidBrush trackBrush = new SolidBrush(Color.FromArgb(214, 223, 247))) g.FillRectangle(trackBrush, rect);
                using (Pen borderPen = new Pen(Color.FromArgb(122, 150, 223))) g.DrawRectangle(borderPen, rect);
                if (_value > 0 && _maximum > 0)
                {
                    ...
                    if (fillWidth > 0)
                    {
                        ...
                        using (LinearGradientBrush fillBrush = new LinearGradientBrush(fillRect, Color.FromArgb(158, 190, 245), Color.FromArgb(59, 116, 227), 90f)) g.FillRectangle(fillBrush, fillRect);
                        using (Pen highlightPen = new Pen(Color.FromArgb(80, 255, 255, 255))) g.DrawLine(highlightPen, 1, 1, fillWidth, 1);
                    }
                }
            }
            else
            {
                using (LinearGradientBrush trackBrush = new LinearGradientBrush(rect, Color.FromArgb(200, 210, 220), Color.FromArgb(230, 235, 240), 90f)) g.FillRectangle(trackBrush, rect);
                using (Pen borderPen = new Pen(Color.FromArgb(140, 160, 180))) g.DrawRectangle(borderPen, rect);
                if (_value > 0 && _maximum > 0)
                {
                    int fillWidth = (int)((double)_value / _maximum * (Width - 2));
                    if (fillWidth > 0)
                    {
                        Rectangle fillRect = new Rectangle(1, 1, fillWidth, Height - 2);
                        using (LinearGradientBrush fillBrush = new LinearGradientBrush(fillRect, Color.FromArgb(100, 180, 255), Color.FromArgb(50, 140, 220), 90f)) g.FillRectangle(fillBrush, fillRect);
                        Rectangle highlightRect = new Rectangle(1, 1, fillWidth, (Height - 2) / 2);
                        using (LinearGradientBrush highlightBrush = new LinearGradientBrush(highlightRect, Color.FromArgb(80, 255, 255, 255), Color.FromArgb(0, 255, 255, 255), 90f)) g.FillRectangle(highlightBrush, highlightRect);
                    }
                }
            }
        }
